...
import type { NotificationPrefsResponse } from '../../../notifications/api/client.ts';
import { notificationKeys } from '../../../notifications/state/query-keys.ts';
import { useNotificationPrefs, useSetNotificationPref } from './usePrefs.ts';
...
vi.mock('../../../notifications/api/client.ts', () => ({
  notificationsClient: {
...
describe('useSetNotificationPref', () => {
  ...
  it('rolls back on error', async () => {
    const client = await import('../../../notifications/api/client.ts');
    (
